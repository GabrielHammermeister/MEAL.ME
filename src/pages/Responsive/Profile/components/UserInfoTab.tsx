...
export const UserInfoTab = () => {
  const [userProfile, setUserProfile] = useState({
    name: {
      data: 'Gabriel Hammermeister Mena da Costa',
      unit: '',
    },
    weight: { data: 87, unit: 'Kg' },
    age: { data: 22, unit: 'anos' },
    height: { data: 178, unit: 'cm' },
    sex: { data: 'Masculino', unit: '' },
    email: { data: 'gabriel.hammer523@gmail.com', unit: '' },
  })
    ...
    <div className={'flex flex-wrap justify-between items-baseline'}>
      ...
      {isEditing ? (
        ...
        <Typography variant='subtitle2'>
          {userProfileInfo.data} {userProfileInfo.unit}
        </Typography>
      )}
    </div>
  )
